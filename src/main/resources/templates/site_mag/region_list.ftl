...
<body class="mainbody">
<form name="form1" method="post" action="/Verwalter/setting/region/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/setting/region/edit"><i></i><span>新增</span></a></li>
    ...
    <#if region_list??>
        <#list region_list as item>
            <tr>
                ...
                <td><a href="/Verwalter/setting/region/edit?id=${item.id}">${item.title!""}</a></td>
                ...
                <td align="center">
                    <a href="/Verwalter/setting/region/edit?id=${item.id}">修改</a>
                </td>
              </tr>
        </#list>
    </#if>
