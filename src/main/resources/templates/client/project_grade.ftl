	...
	<table class="score">
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select class="setGrade${item_index}" onChange="changeTechnology('${item_index}');" id="${item_index}_oneTechnology" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select class="setGrade${item_index}" onChange="changeTechnology('${item_index}');" id="${item_index}_twoTechnology" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select class="setGrade${item_index}"  onChange="changeTechnology('${item_index}');" id="${item_index}_threeTechnology" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
    			<#list grade_list as item>
    			<td>
    				<select class="setGrade${item_index}"  onChange="changeGroup('${item_index}');" id="${item_index}_oneGroup" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
    				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
            ...
            <#if grade_list??>
                <#list grade_list as item>
                <td>
                    <select class="setGrade${item_index}"  onChange="changeGroup('${item_index}');" id="${item_index}_twoGroup" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
                        <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select  class="setGrade${item_index}" onChange="changeFeasibility('${item_index}');" id="${item_index}_oneFeasibility" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        					<#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>	
			    <#list grade_list as item>
        			<td>
        				<select class="setGrade${item_index}"  onChange="changeFeasibility('${item_index}');" id="${item_index}_twoFeasibility" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select class="setGrade${item_index}"  onChange="changeMarketValue('${item_index}');" id="${item_index}_oneMarketValue" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select  class="setGrade${item_index}" onChange="changeMarketValue('${item_index}');" id="${item_index}_twoMarketValue" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<tr class="tr03 mOn">
			...
			<#if grade_list??>
			    <#list grade_list as item>
        			<td>
        				<select class="setGrade${item_index}"  onChange="changeExpression('${item_index}');" id="${item_index}_oneExpression" <#if type??&&type=="check">disabled="" style="background : #EDEDED;"</#if>>
        				    <#list 0..10 as n>
		...
		<#if !type??>
			<tr class="tr02 mOn">
				...
				<#if grade_list??>
	    			<#list grade_list as item>
	    			     <td><input class="setGrade${item_index}"  <#if  type??&&type=="check" >disabled="" style="background : #EDEDED;"</#if> type="button" onClick="submitPoint('${item_index}','${item.number!''}');" value="确定" /></td>
	    			</#list>
			    </#if>
			</tr>
		</#if>	
