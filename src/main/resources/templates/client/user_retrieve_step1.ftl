...
<form action="/login/retrieve_step" class="lookpsw-form" method="post" id="form1">
	...
	<div class="verification-body">
	   ...
	   <span style="color:#22A011; position:absolute; right:-114px;top:14px;line-height:14px; font-size:16px;"  class="Validform_checktip" ></span>
	 </div>
